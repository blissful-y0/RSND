...
vi.hoisted(() => {
    Object.assign(globalThis, { __NODE__: true })
})
...
const {
    ...
    const storageMocks = {
        ...
        keys: vi.fn(async (prefix?: string) => prefix ? [] : ['assets/new-bot.png']),
...
vi.mock('./stores.svelte', () => ({
    ...
    bootBackupPromptStore: createMockStore(false),
}))
...
describe('loadData cleanChunks', () => {
    beforeEach(() => {
        ...
        storageMocks.keys.mockImplementation(async (prefix?: string) => prefix ? [] : ['assets/new-bot.png'])
